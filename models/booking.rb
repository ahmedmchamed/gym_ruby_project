...
class Booking
    ...
    attr_accessor :member_id, :staff_id, :gymclass_id, :dates_id, :membership_id
    attr_reader :id
    ...
    def save()
        ...
        (member_id, staff_id, gymclass_id, dates_id, membership_id)
        VALUES ($1, $2, $3, $4, $5) RETURNING id;"
        values = [@member_id, @staff_id, @gymclass_id, @dates_id, @membership_id]
    ...
    def update_booking()
        ...
        values = [@member_id, @staff_id, @gymclass_id, @dates_id, @membership_id, @id]
